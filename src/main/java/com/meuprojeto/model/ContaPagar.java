...
public class ContaPagar implements Serializable {
    ...
    @NotNull(message = "Informar o campo descrição da conta a pagar")
    @Column(nullable = false)
    private String descricao;


    @NotNull(message = "Informar o valor total conta a pagar")
    @Column(nullable = false)
    ...
    @NotNull(message = "Informar o status da conta a pagar")
    @Column(nullable = false)
    @Enumerated(EnumType.STRING)
    private StatusContaPagar status;


    @NotNull(message = "Informar o vencimento da conta a pagar")
    @Column(nullable = false)
